    ...
    methods:{
        getData: function(){
            axios.get("/api/clients/current/accounts")
                ...
                .catch((error) => {
                    this.errorMsg = "Error al obtener informacion";
        ...
        checkTransfer: function(){
            if(this.accountFromNumber == "VIN"){
                this.errorMsg = "Debes seleccionar una cuenta de origen";
                this.errorToats.show();
            }
            else if(this.accountToNumber == "VIN"){
                this.errorMsg = "Debes seleccionar una cuenta de destino";
                this.errorToats.show();
            }else if(this.amount == 0){
                this.errorMsg = "Debes indicar un monto";
                this.errorToats.show();
            }
            else if(this.description.length <= 0){
                this.errorMsg = "Debes agregar un comentario";
                this.errorToats.show();
            }else{
                this.modal.show();
            }
        ...
        signOut: function(){
            axios.post('/api/logout')
                ...
                .catch(() =>{
                    this.errorMsg = "Cierre de sesion fallido"
                    this.errorToats.show();
                })
        },
    },
